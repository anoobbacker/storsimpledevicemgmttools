...
.DESCRIPTION
    ...
    4.  Download the script from script center. 
            wget https://github.com/anoobbacker/storsimpledevicemgmttools/raw/master/Authorize-ServiceEncryptionRollover.ps1 -OutAuthorize-ServiceEncryptionRollover.ps1

...
.DESCRIPTION
    ...
    4.  Download the script from script center. 
            ...
            .\Get-DeviceUpdateAvailability.ps1 -SubscriptionId [subid] -TenantId [tenantid] -ResourceGroupName [resource group] -ManagerName [device manager] -DeviceName [device name] -AuthNType [Type of auth] -AADAppId [AAD app Id] -AADAppAuthNKey [AAD App Auth Key]

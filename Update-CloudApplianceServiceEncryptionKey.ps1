...
.DESCRIPTION
    ...
    4.  Download the script from script center. 
            ...
            .\Update-CloudApplianceServiceEncryptionKey.ps1 -SubscriptionId [subid] -TenantId [tenantid] -ResourceGroupName [resource group] -ManagerName [device manager] -AuthNType [Type of auth] -AADAppId [AAD app Id] -AADAppAuthNKey [AAD App Auth Key]

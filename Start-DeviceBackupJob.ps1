...
.DESCRIPTION
    ...
    4.  Download the script from script center. 
            ...
            > .\Start-DeviceBackupJob.ps1 -SubscriptionId <subid> -TenantId <tenantid> -ResourceGroupName <resource group> -ManagerName <device manager> -DeviceName <device name> -BackupPolicyName <policy name> -BackupType <backup type>

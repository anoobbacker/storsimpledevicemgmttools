...
.DESCRIPTION
    ...
    4.  Download the script from script center. 
            ...
            > .\Verify-BackupScheduleAndBackup.ps1 -SubscriptionId <subid> -TenantId <tenantid> -ResourceGroupName <resource group> -ManagerName <device manager> -DeviceName <device name>
